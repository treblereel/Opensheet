...
import org.opensheet.client.widges.admin.DepartmentFormGrid;
...
public class AdminDepartmentView extends View{
	
    private LayoutContainer container;
	Dispatcher dispatcher = Dispatcher.get();


	public AdminDepartmentView(Controller controller) {
		super(controller);
	}
	...
	protected void handleEvent(AppEvent event) {
		...
		if (event.getType() == AdminEvents.AdminDepartment) {
