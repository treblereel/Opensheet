...
import org.opensheet.client.widges.admin.SettingsTab;
...
public class AdminSettingsView extends View{
	 private LayoutContainer container;
		Dispatcher dispatcher = Dispatcher.get();
	
	
	public AdminSettingsView(Controller controller) {
		super(controller);
	...
	protected void handleEvent(AppEvent event) {
		...
		if (event.getType() == AdminEvents.AdminSettings) {
